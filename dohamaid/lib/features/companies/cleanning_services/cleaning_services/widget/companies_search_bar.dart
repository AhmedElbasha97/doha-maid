...
/// Generic search bar — calls [onChanged] on every keystroke and
/// [onCleared] when the user taps the X button.
///
/// Drop this into any screen that needs live local-search.
class CompaniesSearchBar extends StatelessWidget {
  final TextEditingController controller;
  final ValueChanged<String> onChanged;
  final VoidCallback onCleared;
  final String? hintKey; // translation key, defaults to 'search_hint'
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: const Icon(Icons.search_rounded, color: AppColor.mainColor),
