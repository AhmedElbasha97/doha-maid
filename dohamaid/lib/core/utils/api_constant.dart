class ApiConstant {
  ...
  static String resendingOtpLink = "otp/resend";//post
  ...
  static String nursingCompaniesLink = "companies/4";//get
  static String workerSuppliersLink = "companies/8";//get
  static String companiesServicesLink = "services";//get
  static String countryCodesLink = "countries";//get
  static String companyDetailsLink = "company/";//get
  static String bookingServicesLink = "booking/services";//get
