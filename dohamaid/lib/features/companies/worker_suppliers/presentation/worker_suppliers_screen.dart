...
import 'package:dohamaid/widget/no_data_widget.dart';
...
class WorkerSuppliersScreen extends StatefulWidget {
  const WorkerSuppliersScreen({super.key});

  @override
  State<WorkerSuppliersScreen> createState() => _WorkerSuppliersScreenState();
}

class _WorkerSuppliersScreenState extends State<WorkerSuppliersScreen>
  ...
  void initState() {
    ...
    cubit.loadWorkerSuppliers(controller);
    ...
    Navigator.maybePop(context);
      ...
      body: BlocBuilder<WorkerSuppliersCubit, WorkerSuppliersState>(
        builder: (context, state) {
          ...
          if (state is WorkerSuppliersError) {
